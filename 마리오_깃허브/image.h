...
public:
	...
	inline RECT getBoundingBoxFrame()
	{
		RECT rc = RectMakeCenter(_imageInfo->x, _imageInfo->y, _imageInfo->frameWidth, _imageInfo->frameHeight);
		return rc;
	}
	inline RECT setBoundingBox(int move)
	{
		RECT rc = RectMakeCenter(_imageInfo->x-= move, _imageInfo->y, _imageInfo->width, _imageInfo->height);
